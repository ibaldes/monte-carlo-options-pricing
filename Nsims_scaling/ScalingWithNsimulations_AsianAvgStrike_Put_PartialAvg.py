...
def main():
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut_PartialAvg/MonteCarloPriceConvergence_AsianAvgStrikePutOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut_PartialAvg/MonteCarloDeltaConvergence_AsianAvgStrikePutOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut_PartialAvg/MonteCarloGammaConvergence_AsianAvgStrikePutOption_PartialAvg.jpg")
	plt.clf()		
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut_PartialAvg/MonteCarloVegaConvergence_AsianAvgStrikePutOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut_PartialAvg/MonteCarloThetaConvergence_AsianAvgStrikePutOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut_PartialAvg/MonteCarloRhoConvergence_AsianAvgStrikePutOption_PartialAvg.jpg")
	plt.clf()
