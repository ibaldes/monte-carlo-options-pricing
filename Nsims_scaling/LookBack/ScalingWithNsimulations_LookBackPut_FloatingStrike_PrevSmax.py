...
def main():
	...
	Output_array_2 = np.zeros((n_examples, 12)) # Output array: MonteCarloFloatingStrikeLookBackPutWithGreeks function has an output of length 12	
	Output_array_3 = np.zeros((n_examples, 12)) # Output array: MonteCarloFloatingStrikeLookBackPutWithGreeks function has an output of length 12
	Output_array_4 = np.zeros((n_examples, 12)) # Output array: MonteCarloFloatingStrikeLookBackPutWithGreeks function has an output of length 12					
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = lb.MonteCarloFloatingStrikeLookBackPutWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smaxtodate=Smaxtodate, n_steps=n_steps_1, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = lb.MonteCarloFloatingStrikeLookBackPutWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smaxtodate=Smaxtodate, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = at.MonteCarloFloatingStrikeLookBackPutWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smaxtodate=Smaxtodate, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_4[i, :] = pw.MonteCarloFloatingStrikeLookBackPutWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smaxtodate=Smaxtodate, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	Analytic_array = np.array(lb.AnalyticFloatingStrikeLookBackPutWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smaxtodate=Smaxtodate))
	...
	plt.xscale('log') 
	plt.title(rf'Price of Floating Strike Look Back Put Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smaxtodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFloatingStrike_PrevSmax/MonteCarloPriceConvergence_LookBackPut_FloatingStrike_PrevSmax.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Floating Strike Look Back Put Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smaxtodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFloatingStrike_PrevSmax/MonteCarloDeltaConvergence_LookBackPut_FloatingStrike_PrevSmax.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Floating Strike Look Back Put Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smaxtodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFloatingStrike_PrevSmax/MonteCarloGammaConvergence_LookBackPut_FloatingStrike_PrevSmax.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(0, 0.2)	
	plt.savefig("../../plots/LookBack/LookBackPutFloatingStrike_PrevSmax/MonteCarloGammaConvergence_LookBackPut_FloatingStrike_PrevSmax_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Floating Strike Look Back Put Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smaxtodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFloatingStrike_PrevSmax/MonteCarloVegaConvergence_LookBackPut_FloatingStrike_PrevSmax.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Floating Strike Look Back Put Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smaxtodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFloatingStrike_PrevSmax/MonteCarloThetaConvergence_LookBackPut_FloatingStrike_PrevSmax.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Floating Strike Look Back Put Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smaxtodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFloatingStrike_PrevSmax/MonteCarloRhoConvergence_LookBackPut_FloatingStrike_PrevSmax.jpg")
	plt.clf()
