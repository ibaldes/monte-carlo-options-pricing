...
def main():
	...
	Output_array = np.zeros((n_examples, 12)) # Output array: MonteCarloFloatingStrikeLookBackCallWithGreeks function has an output of length 12
	Output_array_2 = np.zeros((n_examples, 12)) # Output array: MonteCarloFloatingStrikeLookBackCallWithGreeks function has an output of length 12	
	Output_array_3 = np.zeros((n_examples, 12)) # Output array: MonteCarloFloatingStrikeLookBackCallWithGreeks function has an output of length 12
	Output_array_4 = np.zeros((n_examples, 12)) # Output array: MonteCarloFloatingStrikeLookBackCallWithGreeks function has an output of length 12					
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = lb.MonteCarloFloatingStrikeLookBackCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smintodate=Smintodate, n_steps=n_steps_1, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = lb.MonteCarloFloatingStrikeLookBackCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smintodate=Smintodate, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = at.MonteCarloFloatingStrikeLookBackCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smintodate=Smintodate, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_4[i, :] = pw.MonteCarloFloatingStrikeLookBackCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smintodate=Smintodate, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	Analytic_array = np.array(lb.AnalyticFloatingStrikeLookBackCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smintodate=Smintodate))
	...
	plt.xscale('log') 
	plt.title(rf'Price of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike_PrevSmin/MonteCarloPriceConvergence_LookBackCall_FloatingStrike_PrevSmin.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike_PrevSmin/MonteCarloDeltaConvergence_LookBackCall_FloatingStrike_PrevSmin.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike_PrevSmin/MonteCarloGammaConvergence_LookBackCall_FloatingStrike_PrevSmin.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(0, 0.2)	
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike_PrevSmin/MonteCarloGammaConvergence_LookBackCall_FloatingStrike_PrevSmin_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.plot(NSim_array, MonteCarloVega_array_4, '-o', label=fr'Monte Carlo Vega Antithetic + Pathwise n_steps = {n_steps_2}', c='C3')
	plt.fill_between(NSim_array, MonteCarloVega_array_lower_4, MonteCarloVega_array_upper_4, alpha=0.3, label=f' {CIpercentage}% CI Antithetic + Pathwise n_steps ={n_steps_2}')			
	plt.axhline(y=AnalyticVega, color='r', linestyle='--', label=r'Analytic Vega')
	plt.xscale('log') 
	plt.title(rf'Vega of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike_PrevSmin/MonteCarloVegaConvergence_LookBackCall_FloatingStrike_PrevSmin.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike_PrevSmin/MonteCarloThetaConvergence_LookBackCall_FloatingStrike_PrevSmin.jpg")
	plt.clf()
	...
	plt.plot(NSim_array, MonteCarloRho_array_4, '-o', label=fr'Monte Carlo $\rho$ Antithetic + Pathwise n_steps ={n_steps_2}', c='C3')
	plt.fill_between(NSim_array, MonteCarloRho_array_lower_4, MonteCarloRho_array_upper_4, alpha=0.3, label=f' {CIpercentage}% CI Antithetic + Pathwise n_steps ={n_steps_2}')			
	plt.axhline(y=AnalyticRho, color='r', linestyle='--', label=r'Analytic $\rho$')
	plt.xscale('log') 
	plt.title(rf'Rho of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike_PrevSmin/MonteCarloRhoConvergence_LookBackCall_FloatingStrike_PrevSmin.jpg")
	plt.clf()
