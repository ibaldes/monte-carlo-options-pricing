...
def main():
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = lb.MonteCarloFloatingStrikeLookBackCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smintodate=None, n_steps=n_steps_1, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = lb.MonteCarloFloatingStrikeLookBackCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smintodate=None, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_4[i, :] = pw.MonteCarloFloatingStrikeLookBackCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Smintodate=None, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	plt.xscale('log') 
	plt.title(rf'Price of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike/MonteCarloPriceConvergence_LookBackCall_FloatingStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike/MonteCarloDeltaConvergence_LookBackCall_FloatingStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike/MonteCarloGammaConvergence_LookBackCall_FloatingStrike.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(0, 0.2)	
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike/MonteCarloGammaConvergence_LookBackCall_FloatingStrike_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike/MonteCarloVegaConvergence_LookBackCall_FloatingStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike/MonteCarloThetaConvergence_LookBackCall_FloatingStrike.jpg")
	plt.clf()
	...
	plt.plot(NSim_array, MonteCarloRho_array_4, '-o', label=fr'Monte Carlo $\rho$ Antithetic + Pathwise n_steps ={n_steps_2}', c='C2')
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Floating Strike Look Back Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFloatingStrike/MonteCarloRhoConvergence_LookBackCall_FloatingStrike.jpg")
	plt.clf()
