...
def main():
	...
	for i in range(0,n_examples):
		...
		Output_array_4[i, :] = pw.MonteCarloFixedStrikeLookBackCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Smaxtodate=None, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	plt.xscale('log') 
	plt.title(rf'Price of Fixed Strike Look Back Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFixedStrike/MonteCarloPriceConvergence_LookBackCall_FixedStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Fixed Strike Look Back Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFixedStrike/MonteCarloDeltaConvergence_LookBackCall_FixedStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Fixed Strike Look Back Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFixedStrike/MonteCarloGammaConvergence_LookBackCall_FixedStrike.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(0, 0.2)	
	plt.savefig("../../plots/LookBack/LookBackCallFixedStrike/MonteCarloGammaConvergence_LookBackCall_FixedStrike_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.fill_between(NSim_array, MonteCarloVega_array_lower_3, MonteCarloVega_array_upper_3, alpha=0.3, label=f' {CIpercentage}% CI n_steps ={n_steps_2}')
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Fixed Strike Look Back Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFixedStrike/MonteCarloVegaConvergence_LookBackCall_FixedStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Fixed Strike Look Back Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFixedStrike/MonteCarloThetaConvergence_LookBackCall_FixedStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Fixed Strike Look Back Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackCallFixedStrike/MonteCarloRhoConvergence_LookBackCall_FixedStrike.jpg")
	plt.clf()
