...
def main():
	...
	Output_array_3 = np.zeros((n_examples, 12)) # Output array: MonteCarloFixedStrikeLookBackPutWithGreeks function has an output of length 12
	Output_array_4 = np.zeros((n_examples, 12)) # Output array: MonteCarloFixedStrikeLookBackPutWithGreeks function has an output of length 12					
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = lb.MonteCarloFixedStrikeLookBackPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Smintodate=Smintodate, n_steps=n_steps_1, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = lb.MonteCarloFixedStrikeLookBackPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Smintodate=Smintodate, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = at.MonteCarloFixedStrikeLookBackPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Smintodate=Smintodate, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_4[i, :] = pw.MonteCarloFixedStrikeLookBackPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Smintodate=Smintodate, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	Analytic_array = np.array(lb.AnalyticFixedStrikeLookBackPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Smintodate=Smintodate))
	...
	plt.xscale('log') 
	plt.title(rf'Price of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike_PrevSmin/MonteCarloPriceConvergence_LookBackPut_FixedStrike_PrevSmin.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike_PrevSmin/MonteCarloDeltaConvergence_LookBackPut_FixedStrike_PrevSmin.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike_PrevSmin/MonteCarloGammaConvergence_LookBackPut_FixedStrike_PrevSmin.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(0, 0.2)	
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike_PrevSmin/MonteCarloGammaConvergence_LookBackPut_FixedStrike_PrevSmin_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike_PrevSmin/MonteCarloVegaConvergence_LookBackPut_FixedStrike_PrevSmin.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike_PrevSmin/MonteCarloThetaConvergence_LookBackPut_FixedStrike_PrevSmin.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Smintodate})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike_PrevSmin/MonteCarloRhoConvergence_LookBackPut_FixedStrike_PrevSmin.jpg")
	plt.clf()
