...
def main():
	...
	for i in range(0,n_examples):
		...
		Output_array_4[i, :] = pw.MonteCarloFixedStrikeLookBackPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Smintodate=None, n_steps=n_steps_2, n_simulations=NSim_array[i])
	...
	plt.xscale('log') 
	plt.title(rf'Price of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike/MonteCarloPriceConvergence_LookBackPut_FixedStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike/MonteCarloDeltaConvergence_LookBackPut_FixedStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike/MonteCarloGammaConvergence_LookBackPut_FixedStrike.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(0, 0.2)	
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike/MonteCarloGammaConvergence_LookBackPut_FixedStrike_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike/MonteCarloVegaConvergence_LookBackPut_FixedStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike/MonteCarloThetaConvergence_LookBackPut_FixedStrike.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Fixed Strike Look Back Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/LookBack/LookBackPutFixedStrike/MonteCarloRhoConvergence_LookBackPut_FixedStrike.jpg")
	plt.clf()
