...
def main():
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall_PartialAvg/MonteCarloPriceConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall_PartialAvg/MonteCarloDeltaConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall_PartialAvg/MonteCarloGammaConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()		
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall_PartialAvg/MonteCarloVegaConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall_PartialAvg/MonteCarloThetaConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall_PartialAvg/MonteCarloRhoConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
