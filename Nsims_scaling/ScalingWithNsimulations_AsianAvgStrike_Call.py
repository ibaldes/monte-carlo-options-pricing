...
def main():
	...
	plt.xscale('log') 
	plt.title(f'Price of Asian Avg. Strike Call Option (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price ($)')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall/MonteCarloPriceConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Delta of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall/MonteCarloDeltaConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Gamma of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ $(\$)^{-1}$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall/MonteCarloGammaConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()		
	...
	plt.xscale('log') 
	plt.title(f'Vega of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega $( \$ \cdot \sqrt{\mathrm{year}} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall/MonteCarloVegaConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Theta of Asian Avg. Strike Call Option (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ $( \$ / \mathrm{year} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall/MonteCarloThetaConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Rho of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ $( \$ \cdot \mathrm{year} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikeCall/MonteCarloRhoConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()
