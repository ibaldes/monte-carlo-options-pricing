...
### Compares the Monte-Carlo of the Asian Average Strike Put with the Analytic  Formula ####
...
def main():
	...
	Analytic_array = np.array(ai.ApproxAvgStrikePutWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity))
	...
	plt.xscale('log') 
	plt.title(rf'Price of Asian Avg. Strike Put Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikePut/MonteCarloPriceConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Asian Avg. Strike Put Option  (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikePut/MonteCarloDeltaConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Asian Avg. Strike Put Option  (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikePut/MonteCarloGammaConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()			
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikePut/MonteCarloVegaConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikePut/MonteCarloRhoConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()
