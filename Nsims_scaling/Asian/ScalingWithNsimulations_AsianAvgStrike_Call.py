...
### Compares the Monte-Carlo of the Asian Average Strike Call with the Analytic  Formula ####
...
def main():
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = ai.MonteCarloAvgStrikeCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = aa.MonteCarloAvgStrikeCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = ap.MonteCarloAvgStrikeCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, n_steps=200, n_simulations=NSim_array[i])

	print('\nPrices and Greeks using Monte-Carlo for the different n_simulations, Antithetic Variates, and Pathwise Method:\n', Output_array_3)
	print('\n')		
	
	Analytic_array = np.array(ai.ApproxAvgStrikeCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity))
	...
	plt.xscale('log') 
	plt.title(rf'Price of Asian Avg. Strike Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall/MonteCarloPriceConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall/MonteCarloDeltaConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall/MonteCarloGammaConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall/MonteCarloVegaConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Asian Avg. Strike Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall/MonteCarloThetaConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(-10, 20)	
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall/MonteCarloThetaConvergence_AsianAvgStrikeCallOption_ZoomedIn.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall/MonteCarloRhoConvergence_AsianAvgStrikeCallOption.jpg")
	plt.clf()
