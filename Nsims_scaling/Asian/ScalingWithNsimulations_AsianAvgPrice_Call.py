...
### Compares the Monte-Carlo of the Asian Average Price Call with the Analytic  Formula ####
...
def main():
	...
	Output_array = np.zeros((n_examples, 12)) # Output array: MonteCarloAvgPriceCallWithGreeks function has an output of length 12
	Output_array_2 = np.zeros((n_examples, 12)) # Output array: MonteCarloAvgPriceCallWithGreeks function has an output of length 12
	Output_array_3 = np.zeros((n_examples, 12)) # Output array: MonteCarloAvgPriceCallWithGreeks function has an output of length 12			
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = ai.MonteCarloAvgPriceCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = aa.MonteCarloAvgPriceCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = ap.MonteCarloAvgPriceCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, n_steps=200, n_simulations=NSim_array[i])
	...
	plt.xscale('log') 
	plt.title(rf'Price of Asian Avg. Price Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall/MonteCarloPriceConvergence_AsianAvgPriceCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Asian Avg. Price Call Option  (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall/MonteCarloDeltaConvergence_AsianAvgPriceCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Asian Avg. Price Call Option  (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall/MonteCarloGammaConvergence_AsianAvgPriceCallOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(0, 0.1)	
	plt.savefig("../../plots/Asian/AsianAvgPriceCall/MonteCarloGammaConvergence_AsianAvgPriceCallOption_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Asian Avg. Price Call Option  (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall/MonteCarloVegaConvergence_AsianAvgPriceCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Asian Avg. Price Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall/MonteCarloThetaConvergence_AsianAvgPriceCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Asian Avg. Price Call Option  (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall/MonteCarloRhoConvergence_AsianAvgPriceCallOption.jpg")
	plt.clf()
