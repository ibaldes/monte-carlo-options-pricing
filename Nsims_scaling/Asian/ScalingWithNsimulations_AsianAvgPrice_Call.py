...
def main():
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = ap.MonteCarloAvgPriceCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, n_steps=100, n_simulations=NSim_array[i])
