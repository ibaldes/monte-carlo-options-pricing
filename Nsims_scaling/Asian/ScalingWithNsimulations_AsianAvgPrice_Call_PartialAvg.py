...
### Compares the Monte-Carlo of the Asian Average Price Call with pre-existing Average with the Analytic  Formula ####
...
def main():
	...
	Output_array_3 = np.zeros((n_examples, 12)) # Output array: BlackScholesVanillaEuropeanCallWithGreeks function has an output of length 12					
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = ai.MonteCarloAvgPriceCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Savgsofar=Savgsofar, n_steps=100, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = aa.MonteCarloAvgPriceCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Savgsofar=Savgsofar, n_steps=100, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = ap.MonteCarloAvgPriceCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Savgsofar=Savgsofar, n_steps=100, n_simulations=NSim_array[i])

	print('\nPrices and Greeks using Monte-Carlo for the different n_simulations, Antithetic Variates, and Pathwise Method:\n', Output_array_3)
	print('\n')		
	
	Analytic_array = np.array(ai.ApproxAvgPriceCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Savgsofar=Savgsofar))
	...
	plt.xscale('log') 
	plt.title(rf'Price of Asian Avg. Price Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall_PartialAvg/MonteCarloPriceConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Asian Avg. Price Call Option  (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall_PartialAvg/MonteCarloDeltaConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Asian Avg. Price Call Option  (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall_PartialAvg/MonteCarloGammaConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(0, 0.1)	
	plt.savefig("../../plots/Asian/AsianAvgPriceCall_PartialAvg/MonteCarloGammaConvergence_AsianAvgPriceCallOption_PartialAvg_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Asian Avg. Price Call Option  (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall_PartialAvg/MonteCarloVegaConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Asian Avg. Price Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall_PartialAvg/MonteCarloThetaConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Asian Avg. Price Call Option  (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgPriceCall_PartialAvg/MonteCarloRhoConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
