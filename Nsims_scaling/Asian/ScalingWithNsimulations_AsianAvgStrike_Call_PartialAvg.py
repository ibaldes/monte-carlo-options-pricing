...
### Compares the Monte-Carlo of the Asian Average Strike Call with pre-existing Average with the Analytic  Formula ####
...
def main():
	...
	Output_array = np.zeros((n_examples, 12)) # Output array: MonteCarloAvgStrikeCallWithGreeks function has an output of length 12
	Output_array_2 = np.zeros((n_examples, 12)) # Output array: MonteCarloAvgStrikeCallWithGreeks function has an output of length 12
	Output_array_3 = np.zeros((n_examples, 12)) # Output array: MonteCarloAvgStrikeCallWithGreeks function has an output of length 12					
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = ai.MonteCarloAvgStrikeCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Savgsofar=Savgsofar, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = aa.MonteCarloAvgStrikeCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Savgsofar=Savgsofar, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = ap.MonteCarloAvgStrikeCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Savgsofar=Savgsofar, n_steps=200, n_simulations=NSim_array[i])

	print('\nPrices and Greeks using Monte-Carlo for the different n_simulations, Antithetic Variates, and Pathwise Method:\n', Output_array_3)
	print('\n')		
	
	Analytic_array = np.array(ai.ApproxAvgStrikeCallWithGreeks(Stockprice, interest, volatility, timenow, timeatmaturity, Savgsofar=Savgsofar))
	...
	plt.xscale('log') 
	plt.title(rf'Price of Asian Avg. Strike Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall_PartialAvg/MonteCarloPriceConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall_PartialAvg/MonteCarloDeltaConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall_PartialAvg/MonteCarloGammaConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(0, 0.005)	
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall_PartialAvg/MonteCarloGammaConvergence_AsianAvgStrikeCallOption_PartialAvg_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall_PartialAvg/MonteCarloVegaConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Asian Avg. Strike Call Option (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall_PartialAvg/MonteCarloThetaConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(-10, 20)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall_PartialAvg/MonteCarloThetaConvergence_AsianAvgStrikeCallOption_PartialAvg_ZoomedIn.jpg")
	plt.clf()	
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Asian Avg. Strike Call Option  (S={Stockprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, $\bar{{S}}$={Savgsofar})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Asian/AsianAvgStrikeCall_PartialAvg/MonteCarloRhoConvergence_AsianAvgStrikeCallOption_PartialAvg.jpg")
	plt.clf()
