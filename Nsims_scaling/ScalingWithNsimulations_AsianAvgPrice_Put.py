...
def main():
	...
	plt.xscale('log') 
	plt.title(f'Price of Asian Avg. Price Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price ($)')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPricePut/MonteCarloPriceConvergence_AsianAvgPricePutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Delta of Asian Avg. Price Put Option  (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPricePut/MonteCarloDeltaConvergence_AsianAvgPricePutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Gamma of Asian Avg. Price Put Option  (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ $(\$)^{-1}$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPricePut/MonteCarloGammaConvergence_AsianAvgPricePutOption.jpg")
	plt.clf()		
	...
	plt.xscale('log') 
	plt.title(f'Vega of Asian Avg. Price Put Option  (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega $( \$ \cdot \sqrt{\mathrm{year}} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPricePut/MonteCarloVegaConvergence_AsianAvgPricePutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Theta of Asian Avg. Price Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ $( \$ / \mathrm{year} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPricePut/MonteCarloThetaConvergence_AsianAvgPricePutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Rho of Asian Avg. Price Put Option  (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ $( \$ \cdot \mathrm{year} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPricePut/MonteCarloRhoConvergence_AsianAvgPricePutOption.jpg")
	plt.clf()
