...
def main():
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = eb.MonteCarloKnockOutEuropeanCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockOutBarrier, n_steps=100, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = at.MonteCarloKnockOutEuropeanCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockOutBarrier, n_steps=100, n_simulations=NSim_array[i])
	...
	plt.xscale('log') 
	plt.title(f'Price of Knock-Out Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price ($)')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloPriceConvergence_KnockOutBarrierCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Delta of Knock-Out Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloDeltaConvergence_KnockOutBarrierCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Gamma of Knock-Out Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ $(\$)^{-1}$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloGammaConvergence_KnockOutBarrierCallOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(-50, 50)	
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloGammaConvergence_KnockOutBarrierCallOption_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(f'Vega of Knock-Out Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega $( \$ \cdot \sqrt{\mathrm{year}} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloVegaConvergence_KnockOutBarrierCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Theta of Knock-Out Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ $( \$ / \mathrm{year} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloThetaConvergence_KnockOutBarrierCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Rho of Knock-Out Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ $( \$ \cdot \mathrm{year} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloRhoConvergence_KnockOutBarrierCallOption.jpg")
	plt.clf()
