...
def main():
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloPriceConvergence_BarrierCallOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloDeltaConvergence_BarrierCallOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloGammaConvergence_BarrierCallOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e7)
	plt.ylim(-1, 1)	
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloGammaConvergence_BarrierCallOption_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloVegaConvergence_BarrierCallOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloThetaConvergence_BarrierCallOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("../plots/BarrierKnockOutCallOptionConvergence/MonteCarloRhoConvergence_BarrierCallOption.jpg")
	plt.clf()
