...
from options_benchmark import EuropeanVanilla as ev
from options_antithetic import EuropeanVanillaAntithetic as at
from options_pathwise import EuropeanVanillaPathwise as pw
...
def main():
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = pw.MonteCarloVanillaEuropeanCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, n_steps=100, n_simulations=NSim_array[i])
	...
	plt.xscale('log') 
	plt.title(rf'Price of Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/CallOptionConvergence/MonteCarloPriceConvergence_CallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/CallOptionConvergence/MonteCarloDeltaConvergence_CallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/CallOptionConvergence/MonteCarloGammaConvergence_CallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/CallOptionConvergence/MonteCarloVegaConvergence_CallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/CallOptionConvergence/MonteCarloThetaConvergence_CallOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(10, 20)	
	plt.savefig("../../plots/Vanilla/CallOptionConvergence/MonteCarloThetaConvergence_CallOption_ZoomedIn.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/CallOptionConvergence/MonteCarloRhoConvergence_CallOption.jpg")
	plt.clf()
