...
def main():
	...
	Output_array_3 = np.zeros((n_examples, 12)) # Output array: BlackScholesVanillaEuropeanPutWithGreeks function has an output of length 12		
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = pw.MonteCarloVanillaEuropeanPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, n_steps=100, n_simulations=NSim_array[i])
	...
	plt.xscale('log') 
	plt.title(rf'Price of Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/PutOptionConvergence/MonteCarloPriceConvergence_PutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/PutOptionConvergence/MonteCarloDeltaConvergence_PutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/PutOptionConvergence/MonteCarloGammaConvergence_PutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/PutOptionConvergence/MonteCarloVegaConvergence_PutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/PutOptionConvergence/MonteCarloThetaConvergence_PutOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(5, 15)	
	plt.savefig("../../plots/Vanilla/PutOptionConvergence/MonteCarloThetaConvergence_PutOption_ZoomedIn.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Vanilla/PutOptionConvergence/MonteCarloRhoConvergence_PutOption.jpg")
	plt.clf()
