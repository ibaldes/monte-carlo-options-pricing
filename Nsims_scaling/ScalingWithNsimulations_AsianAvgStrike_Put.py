...
def main():
	...
	plt.xscale('log') 
	plt.title(f'Price of Asian Avg. Strike Put Option (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price ($)')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut/MonteCarloPriceConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Delta of Asian Avg. Strike Put Option  (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut/MonteCarloDeltaConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Gamma of Asian Avg. Strike Put Option  (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ $(\$)^{-1}$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut/MonteCarloGammaConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()		
	...
	plt.xscale('log') 
	plt.title(f'Vega of Asian Avg. Strike Put Option  (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega $( \$ \cdot \sqrt{\mathrm{year}} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut/MonteCarloVegaConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Theta of Asian Avg. Strike Put Option (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ $( \$ / \mathrm{year} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut/MonteCarloThetaConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(f'Rho of Asian Avg. Strike Put Option  (S={Stockprice}, r={interest}, sigma={volatility}, t={timenow}, T={timeatmaturity})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ $( \$ \cdot \mathrm{year} )$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgStrikePut/MonteCarloRhoConvergence_AsianAvgStrikePutOption.jpg")
	plt.clf()
