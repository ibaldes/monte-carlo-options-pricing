...
### Compares the Monte-Carlo of the Knock In Barrier Call Option with the Analytic Formula ####
...
def main():
	...
	Output_array_3 = np.zeros((n_examples, 12)) # Output array: MonteCarloKnockInEuropeanCallWithGreeks function has an output of length 12			
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = eb.MonteCarloKnockInEuropeanCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockInBarrier, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = at.MonteCarloKnockInEuropeanCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockInBarrier, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = pw.MonteCarloKnockInEuropeanCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockInBarrier, n_steps=200, n_simulations=NSim_array[i])
	...
	plt.xscale('log') 
	plt.title(rf'Price of Knock-In Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend(loc='lower right')
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInCallOptionConvergence/MonteCarloPriceConvergence_KnockInBarrierCallOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Knock-In Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInCallOptionConvergence/MonteCarloDeltaConvergence_KnockInBarrierCallOption.jpg")
	plt.clf()
	...
	plt.plot(NSim_array, MonteCarloDelta_array_2, '-o', label=fr'Monte Carlo $\Delta$ Antithetic', c='C1')
	plt.fill_between(NSim_array, MonteCarloDelta_array_lower_2, MonteCarloDelta_array_upper_2, alpha=0.3, label=f' {CIpercentage}% CI Antithetic')
	plt.plot(NSim_array, MonteCarloDelta_array_3, '-o', label=fr'Monte Carlo $\Delta$ Antithetic', c='C2')
	plt.fill_between(NSim_array, MonteCarloDelta_array_lower_3, MonteCarloDelta_array_upper_3, alpha=0.3, label=f' {CIpercentage}% CI Antithetic + Pathwise')
	plt.axhline(y=AnalyticDelta, color='r', linestyle='--', label=r'Analytic $\Delta$')
	plt.xscale('log') 
	plt.title(rf'Delta of Knock-In Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(0, 1)	
	plt.savefig("../../plots/Barrier/BarrierKnockInCallOptionConvergence/MonteCarloDeltaConvergence_KnockInBarrierCallOption_ZoomedIn.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Knock-In Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInCallOptionConvergence/MonteCarloGammaConvergence_KnockInBarrierCallOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(-0.1, 0.1)	
	plt.savefig("../../plots/Barrier/BarrierKnockInCallOptionConvergence/MonteCarloGammaConvergence_KnockInBarrierCallOption_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Knock-In Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInCallOptionConvergence/MonteCarloVegaConvergence_KnockInBarrierCallOption.jpg")
	plt.clf()
	...
	plt.plot(NSim_array, MonteCarloTheta_array_3, '-o', label=fr'Monte Carlo $\Theta$ Antithetic + Pathwise', c='C2')
	plt.fill_between(NSim_array, MonteCarloTheta_array_lower_3, MonteCarloTheta_array_upper_3, alpha=0.3, label=f' {CIpercentage}% CI Antithetic + Pathwise')	
	plt.axhline(y=AnalyticTheta, color='r', linestyle='--', label=r'Analytic $\Theta$')
	plt.xscale('log') 
	plt.title(rf'Theta of Knock-In Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()	
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInCallOptionConvergence/MonteCarloThetaConvergence_KnockInBarrierCallOption.jpg")
	plt.clf()
...
#	plt.fill_between(NSim_array, MonteCarloTheta_array_lower_3, MonteCarloTheta_array_upper_3, alpha=0.3, label=f' {CIpercentage}% CI Antithetic + Pathwise')	
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(10, 20)	
	plt.savefig("../../plots/Barrier/BarrierKnockInCallOptionConvergence/MonteCarloThetaConvergence_KnockInBarrierCallOption_ZoomedIn.jpg")
	plt.clf()	
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Knock-In Call Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInCallOptionConvergence/MonteCarloRhoConvergence_KnockInBarrierCallOption.jpg")
	plt.clf()
