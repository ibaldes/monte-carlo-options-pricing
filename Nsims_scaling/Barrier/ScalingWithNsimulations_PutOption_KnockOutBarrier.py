...
def main():
	...
	Output_array_3 = np.zeros((n_examples, 12)) # Output array: MonteCarloKnockOutEuropeanPutWithGreeks function has an output of length 12		
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = eb.MonteCarloKnockOutEuropeanPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockOutBarrier, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = at.MonteCarloKnockOutEuropeanPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockOutBarrier, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = pw.MonteCarloKnockOutEuropeanPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockOutBarrier, n_steps=200, n_simulations=NSim_array[i])
	...
	plt.xscale('log') 
	plt.title(rf'Price of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockOutPutOptionConvergence/MonteCarloPriceConvergence_KnockOutBarrierPutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockOutPutOptionConvergence/MonteCarloDeltaConvergence_KnockOutBarrierPutOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(-1, 1)	
	plt.savefig("../../plots/Barrier/BarrierKnockOutPutOptionConvergence/MonteCarloDeltaConvergence_KnockOutBarrierPutOption_ZoomedIn.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockOutPutOptionConvergence/MonteCarloGammaConvergence_KnockOutBarrierPutOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(-0.1, 0.1)
	plt.savefig("../../plots/Barrier/BarrierKnockOutPutOptionConvergence/MonteCarloGammaConvergence_KnockOutBarrierPutOption_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockOutPutOptionConvergence/MonteCarloVegaConvergence_KnockOutBarrierPutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockOutPutOptionConvergence/MonteCarloThetaConvergence_KnockOutBarrierPutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockOutPutOptionConvergence/MonteCarloRhoConvergence_KnockOutBarrierPutOption.jpg")
	plt.clf()
