...
def main():
	...
	plt.xscale('log') 
	plt.title(rf'Price of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockOutBarrier})')
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Knock Out Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockOutBarrier})')
	plt.xlabel('Number of Simulations')
