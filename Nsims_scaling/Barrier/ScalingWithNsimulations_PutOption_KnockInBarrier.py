...
def main():
	...
	plt.xscale('log') 
	plt.title(rf'Price of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockInBarrier})')
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, H={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
