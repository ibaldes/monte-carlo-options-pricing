...
def main():
	...
	Output_array_2 = np.zeros((n_examples, 12)) # Output array: MonteCarloKnockInEuropeanPutWithGreeks function has an output of length 12	
	Output_array_3 = np.zeros((n_examples, 12)) # Output array: MonteCarloKnockInEuropeanPutWithGreeks function has an output of length 12		
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = eb.MonteCarloKnockInEuropeanPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockInBarrier, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_2[i, :] = at.MonteCarloKnockInEuropeanPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockInBarrier, n_steps=200, n_simulations=NSim_array[i])
	...
	for i in range(0,n_examples):
		...
		Output_array_3[i, :] = pw.MonteCarloKnockInEuropeanPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockInBarrier, n_steps=200, n_simulations=NSim_array[i])
	...
	Analytic_array = np.array(eb.AnalyticBlackScholesKnockInPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, KnockInBarrier))
	...
	plt.xscale('log') 
	plt.title(rf'Price of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel('Price [$]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInPutOptionConvergence/MonteCarloPriceConvergence_KnockInBarrierPutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Delta of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Delta$')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInPutOptionConvergence/MonteCarloDeltaConvergence_KnockInBarrierPutOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(-1, 1)	
	plt.savefig("../../plots/Barrier/BarrierKnockInPutOptionConvergence/MonteCarloDeltaConvergence_KnockInBarrierPutOption_ZoomedIn.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Gamma of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Gamma$ [$ 1/\$ $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInPutOptionConvergence/MonteCarloGammaConvergence_KnockInBarrierPutOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e6)
	plt.ylim(-0.1, 0.1)
	plt.savefig("../../plots/Barrier/BarrierKnockInPutOptionConvergence/MonteCarloGammaConvergence_KnockInBarrierPutOption_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.plot(NSim_array, MonteCarloVega_array_3, '-o', label=fr'Monte Carlo Vega Antithetic + Pathwise', c='C1')
	...
	plt.xscale('log') 
	plt.title(rf'Vega of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'Vega [$ \$ \cdot \sqrt{\mathrm{year}}$ ]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInPutOptionConvergence/MonteCarloVegaConvergence_KnockInBarrierPutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Theta of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\Theta$ [$ \$ / \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInPutOptionConvergence/MonteCarloThetaConvergence_KnockInBarrierPutOption.jpg")
	plt.clf()
	...
	plt.xscale('log') 
	plt.title(rf'Rho of Knock-In Put Option (S={Stockprice}, K={Strikeprice}, r={interest}, $\sigma$={volatility}, t={timenow}, T={timeatmaturity}, B={KnockInBarrier})')
	plt.xlabel('Number of Simulations')
	plt.ylabel(r'$\rho$ [$ \$ \cdot \mathrm{year} $]')
	plt.legend()
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../../plots/Barrier/BarrierKnockInPutOptionConvergence/MonteCarloRhoConvergence_KnockInBarrierPutOption.jpg")
	plt.clf()
