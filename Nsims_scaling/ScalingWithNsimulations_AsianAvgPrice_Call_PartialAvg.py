...
def main():
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPriceCall_PartialAvg/MonteCarloPriceConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPriceCall_PartialAvg/MonteCarloDeltaConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPriceCall_PartialAvg/MonteCarloGammaConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()		
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPriceCall_PartialAvg/MonteCarloVegaConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPriceCall_PartialAvg/MonteCarloThetaConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e6)
	plt.savefig("../plots/AsianAvgPriceCall_PartialAvg/MonteCarloRhoConvergence_AsianAvgPriceCallOption_PartialAvg.jpg")
	plt.clf()
