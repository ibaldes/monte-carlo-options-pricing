...
import EuropeanBarrierAntithetic as at
...
def main():
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/BarrierPutOptionConvergence/MonteCarloPriceConvergence_BarrierPutOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/BarrierPutOptionConvergence/MonteCarloDeltaConvergence_BarrierPutOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/BarrierPutOptionConvergence/MonteCarloGammaConvergence_BarrierPutOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e7)
	plt.ylim(-1, 1)	
	plt.savefig("./plots/BarrierPutOptionConvergence/MonteCarloGammaConvergence_BarrierPutOption_ZoomedIn.jpg")
	plt.clf()			
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/BarrierPutOptionConvergence/MonteCarloVegaConvergence_BarrierPutOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/BarrierPutOptionConvergence/MonteCarloThetaConvergence_BarrierPutOption.jpg")
	plt.clf()
	...
	plt.xlim(1e1, 1e7)
	plt.ylim(-20, 0)	
	plt.savefig("./plots/BarrierPutOptionConvergence/MonteCarloThetaConvergence_BarrierPutOption_ZoomedIn.jpg")
	plt.clf()	
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/BarrierPutOptionConvergence/MonteCarloRhoConvergence_BarrierPutOption.jpg")
	plt.clf()
