...
def main():
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = lb.MonteCarloFixedStrikeLookBackCallWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Smaxtodate=None, n_steps=100, n_simulations=NSim_array[i])
