...
def main():
	...
	for i in range(0,n_examples):
		...
		Output_array[i, :] = lb.MonteCarloFixedStrikeLookBackPutWithGreeks(Stockprice, Strikeprice, interest, volatility, timenow, timeatmaturity, Smintodate=None, n_steps=100, n_simulations=NSim_array[i])
