...
#	NSim_array = np.array([10, 20, 40, 70, 100, 200, 400, 700, 1e3, 2e3, 4e3, 7e3, 1e4, 2e4, 4e4, 7e4, 1e5, 2e5, 4e5, 7e5, 1e6, 2e6, 4e6, 7e6, 1e7]) ##### array of n_simulations values to scan over
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/MonteCarloPriceConvergence_PutOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/MonteCarloDeltaConvergence_PutOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/MonteCarloGammaConvergence_PutOption.jpg")
	plt.clf()		
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/MonteCarloVegaConvergence_PutOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/MonteCarloThetaConvergence_PutOption.jpg")
	plt.clf()
	...
	plt.grid(True)
	plt.xlim(1e1, 1e7)
	plt.savefig("./plots/MonteCarloRhoConvergence_PutOption.jpg")
	plt.clf()
